...
import type { AppState, SliderType, Stimulus, StimulusMode, MemorySequenceLength, ArrowMode, ArrowStyle } from './types';
...
const App: React.FC = () => {
    ...
    const [state, setState] = useState<AppState>(() => {
        try {
            ...
            if (savedStateJSON) {
                ...
                const arrowStyle = savedState.arrowStyle || 'standard';
    ...
    const tick = useCallback(() => {
        ...
        setState(prevState => {
            ...
            // Position Mode Logic: Apply repeat probability to side selection using getNextItem
            const newArrowSide = getNextItem(['left', 'right'], prevState.arrowSide) as 'left' | 'right';
    ...
    useEffect(() => { // Save to localStorage
        ...
        state.repeatChance, state.customActionsLetters, state.arrowStyle, state.backgroundMode
    ]);
    ...
    const handleCustomActionChange = (actionKey: string, value: string) => {
        setState(s => ({
            ...s,
            customActionsLetters: { ...s.customActionsLetters, [actionKey]: value.slice(0, 1) }
        }));
    };
    ...
    const ArrowIcon = ({ type, className }: { type: string, className: string }) => {
        ...
        if (state.arrowStyle === 'standard') {
            if (type === 'Л') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" /></svg>;
            if (type === 'П') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" /></svg>;
            if (type === 'О') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18" /></svg>;
            if (type === 'В') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3" /></svg>;
        }
        // STYLE: MINIMAL (CHEVRONS)
        else if (state.arrowStyle === 'minimal') {
            if (type === 'Л') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" /></svg>;
            if (type === 'П') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>;
            if (type === 'О') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5" /></svg>; // Chevron Up
            if (type === 'В') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" /></svg>; // Chevron Down
        }
        // STYLE: SOLID (TRIANGLES)
        else if (state.arrowStyle === 'solid') {
            if (type === 'Л') return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M6 12l10-8v16z" /></svg>;
            if (type === 'П') return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M18 12l-10-8v16z" /></svg>;
            if (type === 'О') return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M12 6l-8 10h16z" /></svg>;
            if (type === 'В') return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M12 18l-8-10h16z" /></svg>;
        }
        // STYLE: PIXEL (SQUARE)
        else if (state.arrowStyle === 'pixel') {
             if (type === 'Л') return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M22 10H10V4L2 12l8 8v-6h12v-4z" /></svg>;
             if (type === 'П') return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M2 10h12V4l8 8-8 8v-6H2v-4z" /></svg>;
             if (type === 'О') return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M14 22v-12h6l-8-8-8 8h6v12h4z" /></svg>;
             if (type === 'В') return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M14 2v12h6l-8 8-8-8h6V2h4z" /></svg>;
        }
        // STYLE: BRACKETS (NEW)
        else if (state.arrowStyle === 'brackets') {
             if (type === 'Л') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" /></svg>; // Single Chevron Left
             if (type === 'П') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>; // Single Chevron Right
             if (type === 'О') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l-6 7.5 6 7.5 M15.75 4.5l6 7.5-6 7.5" /></svg>; // Double Chevron Out (< >)
             if (type === 'В') return <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" /></svg>; // Single Chevron Down
        }
    ...
    const DirectionArrow = ({ direction }: { direction: string }) => {
        ...
        // Mapping 'up' based direction to internal types for styling consistency
        let path = null;
        if (state.arrowStyle === 'standard') path = <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5L12 4.5 4.5 12" />;
        else if (state.arrowStyle === 'minimal') path = <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5" />;
        else if (state.arrowStyle === 'solid') path = <path d="M12 6l-8 10h16z" />;
        else if (state.arrowStyle === 'pixel') path = <path d="M14 22v-12h6l-8-8-8 8h6v12h4z" />;
        else if (state.arrowStyle === 'brackets') path = <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5" />;

        return (
            <svg xmlns="http://www.w3.org/2000/svg" fill={state.arrowStyle === 'standard' || state.arrowStyle === 'minimal' || state.arrowStyle === 'brackets' ? 'none' : 'currentColor'} viewBox="0 0 24 24" strokeWidth={4} stroke="currentColor" 
                ...
                {state.isColorEditorVisible ? (
                    ...
                    <div className="fixed inset-0 z-40 flex flex-col bg-neutral-900">
                        ...
                        <div className="h-1/2 bg-neutral-900 flex flex-col px-6 pt-4 pb-4 overflow-hidden relative">
                            ...
                            {/* Close/Apply Button - Positioning: Top Right of Bottom Section (Floating between) */}
                            <div 
                                className="absolute right-6 -top-6 w-12 h-12 flex items-center justify-center cursor-pointer z-50 text-white drop-shadow-md active:scale-95 transition-transform"
                            ...
                            <div className="flex-1 flex flex-col justify-between max-w-md mx-auto w-full gap-2">
                                ...
                                <div className="space-y-1">
                                        ...
                                        {['Л', 'П', 'О', 'В'].map((key) => (
                                            <div key={key} className="flex flex-col gap-0.5">
                                                <input 
                                                    ...
                                                    onChange={(e) => handleCustomActionChange(key, e.target.value)}
                                 ...
                                 {/* 3. Arrow Style Selector (REPLACED INPUTS) */}
                                 <div className="space-y-1">
                                    <div className="text-xs font-medium text-neutral-400 uppercase tracking-wide px-1">Стиль Стрелок</div>
                                    <div className="grid grid-cols-5 gap-2 h-12">
                                        {(['standard', 'minimal', 'solid', 'pixel', 'brackets'] as ArrowStyle[]).map((style) => (
                                            <button 
                                                key={style}
                                                onClick={() => handleArrowStyleChange(style)}
                                                className={`rounded-lg flex items-center justify-center transition-all border-2 ${state.arrowStyle === style ? 'border-blue-500 bg-neutral-800 text-white' : 'border-neutral-800 bg-neutral-800 text-neutral-500 hover:border-neutral-700'}`}
                                            >
                                                {/* Preview Icon (Using Right Arrow or Bracket for preview) */}
                                                <svg xmlns="http://www.w3.org/2000/svg" fill={style === 'standard' || style === 'minimal' || style === 'brackets' ? 'none' : 'currentColor'} viewBox="0 0 24 24" strokeWidth={style === 'standard' || style === 'minimal' || style === 'brackets' ? 3 : 0} stroke="currentColor" className="w-5 h-5">
                                                    {style === 'standard' && <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />}
                                                    {style === 'minimal' && <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />}
                                                    {style === 'solid' && <path d="M18 12l-10-8v16z" />}
                                                    {style === 'pixel' && <path d="M2 10h12V4l8 8-8 8v-6H2v-4z" />}
                                                    {style === 'brackets' && <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l6 7.5-6 7.5" />}
                                                </svg>
                                            </button>
                                        ))}
                                    </div>
                    ...
                    <>
                        {/* REACTION GRID */}
                        {state.displayMode === 'reaction' && (
                            <div 
                                className={`grid gap-1 w-full h-full p-1 transition-opacity duration-300 ${getGridClasses(state.reactionState.gridSize)} ${state.reactionState.isGridVisible ? 'opacity-100' : 'opacity-0'}`}
                                onTouchStart={handleReactionGestureStart}
                                onTouchMove={handleReactionGestureMove}
                                onTouchEnd={handleReactionGestureEnd}
                            >
                                {Array.from({ length: state.reactionState.gridSize }).map((_, i) => {
                                    const isSuccess = state.reactionState.successFlashQuadrant === i;
                                    const isActive = state.reactionState.activeQuadrant === i;
                                    
                                    // Determine background color
                                    let bg = 'bg-neutral-800';
                                    if (state.reactionState.isMemoryMode && state.reactionState.isShowingSequence && isActive) {
                                         bg = state.reactionState.activeColor !== 'transparent' ? '' : 'bg-neutral-600';
                                    } else if (isActive) {
                                         bg = state.reactionState.activeColor !== 'transparent' ? '' : 'bg-white';
                                    } else if (isSuccess) {
                                        bg = 'bg-white/50';
                                    }
                                    
                                    const style: React.CSSProperties = {};
                                    if (isActive && state.reactionState.activeColor !== 'transparent') {
                                        style.backgroundColor = state.reactionState.activeColor;
                                    }

                                    return (
                                        <div
                                            key={i}
                                            className={`relative rounded-md flex items-center justify-center overflow-hidden active:scale-95 transition-transform duration-75 ${bg}`}
                                            style={{ ...style, borderColor: gridLineColor, borderWidth: '1px', borderStyle: 'solid' }}
                                            onTouchStart={(e) => handleQuadrantTap(i, e)}
                                        >
                                            {/* Text Content in Cell */}
                                            {isActive && state.reactionState.activeText && (
                                                <span className="font-bold text-neutral-900" style={reactionTextStyle}>
                                                    {state.reactionState.activeText}
                                                </span>
                                            )}
                                        </div>
                                    );
                        ...
                        {/* MOVING DOT OVERLAY (Reaction Mode) */}
                        {state.displayMode === 'reaction' && state.reactionState.isMovingDotActive && (
                            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                                <div 
                                    className="absolute w-6 h-6 bg-red-500 rounded-full shadow-lg transform -translate-x-1/2 -translate-y-1/2 transition-transform duration-75 ease-linear will-change-transform"
                                    style={{ 
                        ...
                        {/* STANDARD DISPLAY (Letter/Arrow) */}
                        {state.displayMode !== 'reaction' && (
                            <div className={`flex flex-col items-center justify-center transition-opacity duration-150 ${state.isLetterVisible ? 'opacity-100' : 'opacity-0'}`}>
                                
                                {/* Top Content (Letter/Digit/Circle) */}
                                {state.contentMode === 'circle' ? (
                                    <div 
                                        className="rounded-full shadow-lg transition-colors duration-200"
                                        style={{ 
                                    ...
                                    <div 
                                        ...
                                        style={{ 
                                            ...letterStyle, 
                                            color: state.displayMode === 'color' ? state.colors[state.action] : 'inherit'
                                        }}
                                    >
                                        {state.letter}
                                    </div>
                                ...
                                {/* Arrow/Action Display */}
                                {state.arrowMode !== 'off' && state.arrowMode !== 'inside' && (
                                    <div 
                                        className="font-bold text-center transition-all duration-200"
                                        style={{ ...actionStyle, color: state.displayMode === 'color' ? state.colors[state.action] : 'inherit' }}
                                    >
                                ...
                                {/* Arrow Inside Logic (Overlay) */}
                                {state.arrowMode === 'inside' && state.contentMode !== 'circle' && (
                        ...
                        {/* --- FOOTER CONTROLS --- */}
                        <div 
                            className={`absolute bottom-0 left-0 w-full p-4 pb-8 transition-all duration-300 z-30 ${controlsVisibilityMode === 2 ? 'translate-y-full opacity-0' : 'translate-y-0 opacity-100'}`}
                            onTouchStart={(e) => {
                                // Only handle visibility toggle if tapping empty space
                                if (e.target === e.currentTarget) handleControlsAreaTap(e);
                            }}
                        >
                            {/* Background for footer */}
                            <div className={`absolute inset-0 bg-gradient-to-t from-black/90 to-transparent pointer-events-none transition-opacity duration-300 ${controlsVisibilityMode === 1 ? 'opacity-0' : 'opacity-100'}`} />

                            <div className="relative flex flex-col gap-3 max-w-md mx-auto">
                                
                                {/* SLIDERS ROW */}
                                <div className="grid grid-cols-2 gap-3">
                                    {state.displayMode === 'reaction' ? (
                                        <>
                                            <SliderBox type="r_min" value={currentReactionSettings.minDelay} config={SLIDER_CONFIG.r_min} onValueChange={handleSliderChange} onTap={handleReactionDelayModeToggle} labelOverride={currentReactionSettings.isFixedDelay ? "Фикс. задержка" : "Мин. задержка"} />
                                            <SliderBox type="r_show" value={currentReactionSettings.showTime} config={SLIDER_CONFIG.r_show} onValueChange={handleSliderChange} onTap={handleShowTimeLinkToggle} isDisabled={currentReactionSettings.isShowTimeLinkedToDelay} labelOverride={currentReactionSettings.isShowTimeLinkedToDelay ? "Время: Авто" : "Время показа"} />
                                        </>
                                    ) : (
                                        <>
                                            <SliderBox type="speed" value={state.baseSpeed} config={SLIDER_CONFIG.speed} onValueChange={handleSliderChange} />
                                            <SliderBox type="dur" value={state.displayDuration} config={SLIDER_CONFIG.dur} onValueChange={handleSliderChange} infinityThreshold={state.baseSpeed} />
                                        </>
                                    )}
                                </div>
                                ...
                                <div className="grid grid-cols-4 gap-3 h-14">
                                    ...
                                    {/* 1. START/STOP (Long Press: Settings) */}
                                    <button
                                        className={`${commonButtonClasses} h-full text-lg ${isAnyRunning ? 'bg-red-600/80 text-white' : 'bg-green-600/80 text-white'}`}
                                        onTouchStart={handleStartButtonPressStart}
                                        onTouchEnd={handleStartButtonPressEnd}
                                    >
                                        {isAnyRunning ? 'СТОП' : 'СТАРТ'}
                                    </button>

                                    {/* 2. MODE SWITCH */}
                                    <button
                                        className={`${commonButtonClasses} h-full flex-col leading-none gap-1`}
                                        onTouchStart={() => handlePressStart(handlePrevDisplayMode)}
                                        onTouchEnd={() => handlePressEnd(handleNextDisplayMode)}
                                    >
                                        <span className="text-[10px] text-neutral-400 uppercase">Режим</span>
                                        <span>{displayModeLabels[state.displayMode]}</span>
                                    </button>
                                    
                                    {/* 3. CONTENT / SUB-MODE SWITCH */}
                                    {state.displayMode === 'reaction' ? (
                                        <button
                                            className={`${commonButtonClasses} h-full flex-col leading-none gap-1`}
                                            onTouchStart={() => handlePressStart(() => state.reactionState.isMemoryMode ? handleChangeMemoryLength() : handlePrevGridSize())}
                                            onTouchEnd={() => handlePressEnd(() => {
                                                if (state.reactionState.isMemoryMode) {
                                                    // Cycle stimulus mode in memory mode
                                                    handleNextStimulusMode();
                                                } else {
                                                    handleNextGridSize();
                                                }
                                            })}
                                        >
                                           {state.reactionState.isMemoryMode ? (
                                               <>
                                                   <span className="text-[10px] text-neutral-400 uppercase">Память {state.reactionState.memorySequenceLength}</span>
                                                   <span className="capitalize">{state.reactionState.stimulusMode}</span>
                                               </>
                                           ) : (
                                               <>
                                                   <span className="text-[10px] text-neutral-400 uppercase">Сетка</span>
                                                   <span>{state.reactionState.gridSize}</span>
                                               </>
                                           )}
                                        </button>
                                    ) : (
                                        <button
                                            className={`${commonButtonClasses} h-full flex-col leading-none gap-1`}
                                            onTouchStart={() => handlePressStart(() => handleContentModeChange(false))}
                                            onTouchEnd={() => handlePressEnd(() => handleContentModeChange(true))}
                                        >
                                            <span className="text-[10px] text-neutral-400 uppercase">Контент</span>
                                            <span>{contentModeLabels[state.contentMode]}</span>
                                        </button>
                                    )}

                                    {/* 4. EXTRA SETTINGS (Arrows/Memory/Obs) */}
                                    {state.displayMode === 'reaction' ? (
                                         <button
                                            className={`${commonButtonClasses} h-full flex-col leading-none gap-1`}
                                            onTouchStart={() => handlePressStart(toggleObservationMode)}
                                            onTouchEnd={() => handlePressEnd(handleToggleMemoryMode)}
                                        >
                                            <span className="text-[10px] text-neutral-400 uppercase">{state.reactionState.isObservationMode ? 'Наблюд.' : state.reactionState.isMemoryMode ? 'Память' : 'Реакция'}</span>
                                            <span>{state.reactionState.isMemoryMode ? 'ВКЛ' : state.reactionState.isObservationMode ? 'ВКЛ' : 'Обычн'}</span>
                                        </button>
                                    ) : (
                                        <button
                                            className={`${commonButtonClasses} h-full flex-col leading-none gap-1`}
                                            onTouchStart={() => handlePressStart(toggleFourArrows)}
                                            onTouchEnd={() => handlePressEnd(handleArrowsToggle)}
                                        >
                                            <span className="text-[10px] text-neutral-400 uppercase">{state.useFourArrows ? '4 Напр.' : '3 Напр.'}</span>
                                            <span>{state.arrowMode === 'off' ? 'Нет' : state.arrowMode === 'inside' ? 'Внутри' : state.arrowMode === 'below' ? 'Снизу' : 'Ранд.'}</span>
                                        </button>
                                    )}
